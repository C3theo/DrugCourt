# Generated by Django 2.1.8 on 2019-06-04 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_fsm.FSMField(choices=[('Pending', 'Pending'), ('Rejected', 'Rejected'), ('Active', 'Active'), ('Terminated', 'Terminated')], db_column='Status', help_text='Current Referral Status', max_length=50)),
                ('division', models.IntegerField(blank=True, db_column='Division', null=True)),
